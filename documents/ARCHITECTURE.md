...
- Only purified textual Indicators of Compromise, routing headers, and extracted URLs are transmitted to Groq inference endpoints, slashing network bandwidth consumption and safeguarding sensitive organizational proprietary documents from full-file external transmission.
