  ...
  return (
    <div className="max-w-xl mx-auto space-y-3 md:space-y-6">
      ...
      <div
        ...
        onDrop={handleDrop}
        className={`cursor-pointer border-2 border-dashed border-cyan-500/20 hover:border-cyan-500/40 bg-zinc-950/70 backdrop-blur-md shadow-xl shadow-cyan-950/30 rounded-xl p-4 sm:p-6 md:p-8 text-center transition-all duration-300 ${
      ...
      >
        {!file ? (
          <div className="flex flex-col items-center space-y-2 md:space-y-4">
            ...
            <div>
              <h3 className="text-sm sm:text-base md:text-lg font-semibold text-zinc-200">Upload QR Artifact</h3>
      ...
      <button
        ...
        className={`w-full py-2.5 md:py-3.5 rounded-xl font-semibold text-xs md:text-sm transition-all flex items-center justify-center space-x-2 cursor-pointer ${
          !file || isLoading
