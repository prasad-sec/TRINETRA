              ...
              {tabs.map(tab => {
                ...
                return (
                  <button
                    ...
                    disabled={isBusy}
                    className={`flex-1 min-w-[78px] md:min-w-0 h-9 md:h-11 px-2 md:px-3 flex items-center justify-center gap-1.5 md:gap-2 text-[10px] md:text-[11px] font-mono font-semibold tracking-wider uppercase leading-none transition-all relative shrink-0 snap-center rounded-none border-b-2 box-border ${
                      isActive 
                ...
                {(investigationState === 'idle' || investigationState === 'error') && (
                  ...
                  >
                    <div className="mb-2 md:mb-8 w-full">
                      <h2 className="font-mono text-sm sm:text-base md:text-2xl font-semibold text-zinc-100 mb-0.5 md:mb-2 tracking-tight">Investigation Workspace</h2>
                      <p className="font-mono text-[10px] sm:text-[11px] md:text-sm text-zinc-400 leading-tight">Submit a suspicious digital artifact to begin an investigation.</p>
                    </div>
                      ...
                      <AnimatePresence mode="wait" initial={false}>
                        ...
                        >
                          {activeTab === 'URL' ? (
                            <div className="flex flex-col gap-2.5 md:gap-4 relative w-full group">
                              <div className="relative flex items-center w-full">
                                ...
                                <input 
                                  ...
                                  className="w-full bg-zinc-950/60 bg-gradient-to-b from-white/5 to-transparent backdrop-blur-xl border border-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] rounded-lg md:rounded-none py-2.5 md:py-5 pl-9 md:pl-14 pr-3.5 md:pr-4 text-zinc-100 font-mono text-xs md:text-base focus:outline-none focus:border-cyan-500/30 focus:shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),0_0_20px_rgba(6,182,212,0.2)] transition-all placeholder:text-zinc-600"
                            ...
                            <div className="flex flex-col items-center justify-center p-6 md:p-12 bg-zinc-950/70 backdrop-blur-md border border-cyan-500/20 hover:border-cyan-500/40 transition-colors rounded-xl shadow-xl shadow-cyan-950/30 w-full">
                               <Shield className="w-8 h-8 md:w-12 md:h-12 text-zinc-600 mb-3 md:mb-4" />
                               <h3 className="text-xs font-mono uppercase tracking-wider text-cyan-400 mb-1.5 md:mb-2">Drop Artifact Here</h3>
