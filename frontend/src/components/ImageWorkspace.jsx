    ...
    return (
        <div className="max-w-xl mx-auto space-y-6 animate-[fadeIn_0.5s_ease-in-out] transition-opacity duration-700 ease-in-out opacity-100">
            ...
            >
                {!file ? (
                    <div className="flex flex-col items-center space-y-4">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold text-zinc-200">Upload Suspicious Image</h3>
            ...
            <button
                ...
                className={`w-full py-3.5 rounded-xl font-semibold text-sm transition-all flex items-center justify-center space-x-2 ${!file || isLoading
